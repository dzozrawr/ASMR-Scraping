...
#pragma warning restore 0649
		...
		public bool shouldOptimizeMesh=false;
		...
		private void StartSlice(BzSliceTryData sliceTryData, Action<BzSliceTryResult> callBack)
		{
			...
			for (int i = 0; i < renderers.Length; i++)
			{
				...
				var meshDissector = new BzMeshDataDissector(mesh, sliceTryData.plane, renderer.sharedMaterials, adapter, configuration, shouldOptimizeMesh);
