...
Shader "Example/URPLitRollingShader"
{
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
              ...
              /*   //LIGHTING PART START///    // this part of the code is copied from Varyings LitPassVertex(Attributes input), it was maybe modified with different variable names
               ...
               // output.normal= input.normalOS.y>0.0001;
               ...
               // output = (Varyings)0;
                ...
                // also required for per-vertex lighting and SH evaluation
              //  VertexNormalInputs normalInput = GetVertexNormalInputs(input.normalOS, input.tangentOS);
                VertexNormalInputs normalInput = GetVertexNormalInputs(output.normal, input.tangentOS);
               ...
               //  output.normalWS = input.normalOS.y>0.0001;
